...
#[cfg(feature = "async")]
#[allow(dead_code)]
impl<'a, B> DriverAsync<'a, BusAsync<'a, &'a mut B>>
where
    B: shared_bus::BusMutex, // I2C: embedded_hal::i2c::I2c<Error = Box<dyn embedded_hal::i2c::Error>>,
                             // Bus<'a, I2C>: bus::BusTrait<Error = Box<dyn embedded_hal::i2c::Error>>,
{
    ...
    pub fn from_i2c(bus: &'a mut BusAsync<'a, &'a mut B>) -> Self {
        // BusAsync<'a, &'a shared_bus::I2cProxy<'a, M>>
